...
class MainPageLocators():
    ...
    FAQ_1_ANSWER = (By.CSS_SELECTOR, '#accordion__panel-0 > p:nth-child(1)')
    FAQ_2 = (By.CSS_SELECTOR, '#accordion__heading-1')
    FAQ_2_ANSWER = (By.CSS_SELECTOR, '#accordion__panel-1 > p:nth-child(1)')
    FAQ_3 = (By.CSS_SELECTOR, '#accordion__heading-2')
    FAQ_3_ANSWER = (By.CSS_SELECTOR, '#accordion__panel-2 > p:nth-child(1)')
    FAQ_4 = (By.CSS_SELECTOR, '#accordion__heading-3')
    FAQ_4_ANSWER = (By.CSS_SELECTOR, '#accordion__panel-3 > p:nth-child(1)')
    FAQ_5 = (By.CSS_SELECTOR, '#accordion__heading-4')
    FAQ_5_ANSWER = (By.CSS_SELECTOR, '#accordion__panel-4 > p:nth-child(1)')
    FAQ_6 = (By.CSS_SELECTOR, '#accordion__heading-5')
    FAQ_6_ANSWER = (By.CSS_SELECTOR, '#accordion__panel-5 > p:nth-child(1)')
    FAQ_7 = (By.CSS_SELECTOR, '#accordion__heading-6')
    FAQ_7_ANSWER = (By.CSS_SELECTOR, '#accordion__panel-6 > p:nth-child(1)')
    FAQ_8 = (By.CSS_SELECTOR, '#accordion__heading-7')
    FAQ_8_ANSWER = (By.CSS_SELECTOR, '#accordion__panel-7 > p:nth-child(1)')
